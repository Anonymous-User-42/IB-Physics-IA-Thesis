...
\large
		...
		\textit{\textbf{Research Question}: How does Temperature of the fluid medium in laminar flow affect the drag force on a spherical body in linear motion? }
...
\section{\textit{Evaluation}}
	...
	\import{Sections}{Evaluation Mod 1}
